...
const Dashboard = () => {
  ...
  const tableExample = [
    {
      avatar: {
        src: 'https://abrakadabra.fun/uploads/posts/2021-12/1640101702_1-abrakadabra-fun-p-itachi-uchikha-avatarka-dlya-stim-1.jpg',
        status: 'success',
      },
      user: {
        name: 'Тамер лох',
      ...
      country: { name: 'Kazakhstan', flag: cifKz },
      usage: {
        value: 10 - 7,
        period: 'Jul 18, 2008 - Feb 27, 2022',
        color: 'success',
      },
  ...
  const { isLoading } = useSelector((state) => state.questionnaireReducer)
  const test = false
